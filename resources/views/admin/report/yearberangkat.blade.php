...
<body>
    ...
    <div class="container">
        ...
        <div class="isi">
            <h3 style="text-align:center;">LAPORAN KEBERANGKATAN HAJI</h3>
            ...
            <table id="myTable" class="table table-bordered table-striped dataTable no-footer text-center" role="grid"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $d->alamat }}</td>
                        <td>{{ $d->telepon }}</td>
                        <td>{{Carbon\carbon::parse($d->tahun)->translatedFormat('d-F-Y')}}</td>
                    </tr>
                    @endforeach
                    <tr>
                        <td colspan="5">Total Jemaah Berangkat Haji</td>
                        <td colspan="">{{$total}}</td>
                    </tr>
                </tbody>
            </table>
