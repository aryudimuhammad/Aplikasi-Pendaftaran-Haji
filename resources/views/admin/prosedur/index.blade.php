@extends('layouts.app')
@section('title') Prosedur Pendaftaran Haji @endsection
@section('head')
...
<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1 class="m-0">Prosedur Pendaftaran Haji</h1>
        </div>
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Prosedur Pendaftaran Haji</a></li>
        </ol>
        </div>
    </div>
    </div>
                  ...
                  @foreach ($data as $d)
                    <tr>
                        ...
                        <td scope="col" class="text-center">
                            ...
                            <button data-target="#modaldelete" data-toggle="modal" type="button" class="delete btn btn-sm bg-danger" data-link="{{ route('adminprosesdurdelete',$d->id) }}"> Hapus</button>
                        </td>
                    </tr>
                    @endforeach
                  </tbody>
...
@include('admin.prosedur.create')
@include('admin.prosedur.edit')
@include('admin.prosedur.delete')
@endsection
@section('script')
