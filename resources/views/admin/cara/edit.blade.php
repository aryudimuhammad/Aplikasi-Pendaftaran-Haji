            ...
            <form method="post" enctype="multipart/form-data">
                    ...
                    <div class=" modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-form-label" for="no">Nomor Persyaratan</label>
                            <input type="text" class="form-control @error ('no') is-invalid @enderror"
                                placeholder="Masukkan Nomor Persyaratan" name="no" value="{{old('no')}}"
                                id="no" autofocus>
                            @error('no')<div class="invalid-feedback"> {{$message}} </div>@enderror
                        </div>
                        <div class="form-group">
                            <label class="col-form-label" for="isi">Isi Persyaratan</label>
                            <textarea type="text" class="form-control @error ('isi') is-invalid @enderror"
                                placeholder="Masukkan Isi Persyaratan" name="isi" value="{{old('isi')}}"
