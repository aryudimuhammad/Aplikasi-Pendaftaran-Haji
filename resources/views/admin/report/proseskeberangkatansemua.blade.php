...
<body>
    ...
    <div class="container">
        ...
        <div class="isi">
            <h3 style="text-align:center;">PERSIAPAN KEBERANGKATAN HAJI</h3>
            <table id="myTable" class="table table-bordered table-striped dataTable no-footer text-center" role="grid"
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>{{ $data->olahraga }}</td>
                        <td>{{ $data->olahragaisi }}</td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>{{ $data->vaksinasi }}</td>
                        <td>{{ $data->vaksinasiisi }}</td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td>{{ $data->kesehatan }}</td>
                        <td>{{ $data->kesehatanisi }}</td>
                    </tr>
                    <tr>
                        <td>4</td>
                        <td>{{ $data->istirahat }}</td>
                        <td>{{ $data->istirahatisi }}</td>
                    </tr>
                    <tr>
                        <td>5</td>
                        <td>{{ $data->obat }}</td>
                    ...
                    <tr>
                        <td>6</td>
                        <td>{{ $data->perjalan }}</td>
                        <td>{{ $data->perjalananisi }}</td>
                    </tr>
                    <tr>
                        <td>7</td>
                        <td>{{ $data->perlengkapan }}</td>
                        <td>{{ $data->perlengkapanisi }}</td>
                    </tr>
                    <tr>
                        <td>8</td>
                        <td>{{ $data->keuangan }}</td>
                    ...
                    <tr>
                        <td>9</td>
                        <td>{{ $data->imantaqwa }}</td>
                        <td>{{ $data->imantaqwaisi }}</td>
                    </tr>
                </tbody>
            </table>
            <br>
